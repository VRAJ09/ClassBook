...
const Setup = () => {
    ...
    return (
        <AuthLayout>
            <Head>
                <title>Setup &middot; ClassBook</title>
                ...
                >
                    ...
                    {user.role_name === 'student' && (
                        <>
                            <div className="mb-3">
                                <p className="px-3">
                                    By creating this account, I understand that
                                    I miss 3 appointments without 2 hour notice
                                    in advance, I will be put under a probation
                                    period of 7 days from signing up. I can
                                    negotiate with my tutor to schedule for a
                                    long term tutoring service, which
                                    constitutes of 6 sessions maximum.
                                </p>
                            </div>
