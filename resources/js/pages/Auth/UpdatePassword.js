...
const UpdatePassword = () => {
    const { data, setData, put, processing, errors, hasErrors, reset } =
        useForm({
            current_password: '',
            password: '',
    ...
    const handleSubmit = e => {
        ...
        put('/user/password', {
            onError: () => reset(),
            onSuccess: () => Inertia.get('/settings'),
        })
    }
    return (
        <AuthLayout>
            <Head>
                <title>
                    Update Password &middot; ClassBook
                </title>
            ...
            <AuthLayout.Content>
                ...
                >
                    ...
                    <div className="mb-3">
                        <input
                            className={`form-field h-12 ${
                                errors.updatePassword?.password ? 'invalid' : ''
                            }`}
                            name="password"
                            type="password"
