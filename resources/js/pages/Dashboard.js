...
const Dashboard = () => {
    ...
    return (
        <AppLayout>
            <Head>
                <title>Dashboard &middot; ClassBook</title>
            ...
            <div
                className={`grid grid-cols-1 mt-3 ${
                    !nextEvent && !todayEvents ? '' : 'sm:grid-cols-2 gap-3'
                }`}
            >
                {!nextEvent && !todayEvents ? (
                    <>
                        <div className="bg-[#DBEAFE] shadow rounded-md py-6 px-4 sm:px-6 lg:px-8">
                            {user.role_name === 'tutor' ? (
                                <h3 className="text-base">
                                    You have no events today or in the nearby
                                    future, but you can create more open
                                    events{' '}
                                    <Link
                                ...
                                <h3 className="text-base">
                                    You have no events today or in the nearby
                                    future, but you can sign up for more
                                    events{' '}
                                    <Link
                                        className="link-inline"
                                        href="/calendar"
                    ...
                    <>
                        <div className="bg-white shadow rounded-md py-6 px-4 sm:px-6 lg:px-8">
                            <h2 className="uppercase text-gray-500 text-xl mb-3">
                                Events today
                            </h2>
                            {todayEvents &&
                            ...
                            {todayEvents ? (
                                ...
                                <h3 className="text-base">
                                    None, but you can create more open events{' '}
                                    <Link
                                        className="link-inline"
                                        href="/calendar"
                                    >
